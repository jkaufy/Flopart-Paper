...
total.min.wide[, diff := train.test_BINSEG-train.test_Flopart]

total.min.wide[, train.test.diff := train.test_BINSEG - train.test_Flopart]
...
total.min.wide[, test.diff_BINSEG := test_BINSEG-test_Flopart]
